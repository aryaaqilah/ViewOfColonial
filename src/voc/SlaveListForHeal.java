...
public class SlaveListForHeal  extends JFrame implements ActionListener{
	private Voc voc;
	private Main main;
//	private PunishFrame punishframe;
	...
	private JLabel lbl_title = new JLabel("CHOOSE SLAVE TO BE HEALED !");
	...
	public SlaveListForHeal() {
		// TODO Auto-generated constructor stub
	}

	public SlaveListForHeal(Voc voc, Main main) throws HeadlessException {
		super();
		this.voc = voc;
		this.main = main;
		initFrame();
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource().equals(btn_heal)) {
			setVisible(false);
...
//			codeInt = Integer.parseInt(txt_job.getText());
			...
			healFrame = new HealFrame(voc, this);
		}
	}
	...
	public void healResult(int result) {
		if(result == 1) {
